...
- [nodes.jsonl](https://cdn.learningcommons.org/knowledge-graph/v1.12.0/exports/nodes.jsonl?ref=github)
- [relationships.jsonl](https://cdn.learningcommons.org/knowledge-graph/v1.12.0/exports/relationships.jsonl?ref=github)
...
```bash
curl -L "https://cdn.learningcommons.org/knowledge-graph/v1.12.0/exports/nodes.jsonl?ref=gh_curl" -o nodes.jsonl
curl -L "https://cdn.learningcommons.org/knowledge-graph/v1.12.0/exports/relationships.jsonl?ref=gh_curl" -o relationships.jsonl
```
