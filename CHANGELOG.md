...
## [1.14.0](https://github.com/learning-commons-org/knowledge-graph/compare/v1.13.1...v1.14.0) (2026-09-09)
...
* **main:** release 1.12.0 ([#42](https://github.com/learning-commons-org/knowledge-graph/issues/42)) ([87cdd0d](https://github.com/learning-commons-org/knowledge-graph/commit/87cdd0d19dfc7ae2554bef8fb2717d83c8df260f))
* **main:** release 1.13.0 ([#44](https://github.com/learning-commons-org/knowledge-graph/issues/44)) ([b5e00d7](https://github.com/learning-commons-org/knowledge-graph/commit/b5e00d7a44780b6a924ba690d076489c713108f4))
* **main:** release 1.13.1 ([#46](https://github.com/learning-commons-org/knowledge-graph/issues/46)) ([f0446a7](https://github.com/learning-commons-org/knowledge-graph/commit/f0446a708ac077711c21da24d0ea1d7192abadd8))
...
- Fixed [US academic standards](https://docs.learningcommons.org/knowledge-graph/datasets/us-academic-standards) data issues
  ...
  - Updated `author` and `attributionStatement` for Indiana Mathematics
